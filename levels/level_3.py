...
from utils.map import mapLevel_3
from game.file import *

from classes.jogador import *
from classes.portas import *
from classes.visual_effects import Particula, random
...
class Level_3:
    def __init__(self, janela):
        ...
        self.tile = TileMap(self.listaImagem, mapLevel_3, self.janela, 16*escalaTile)
        self.porta = Porta(LARGURA/1.15, ALTURA/5.55)
    ...
    def run(self): 
        ...
        if verificarPosicao:
            jogador.rect.center = [LARGURA/3, 550]
