...
from utils.map import mapLevel_1
...
class Level_1():
    def __init__(self, janela):
        ...
        self.tile = TileMap(self.listaImagem, mapLevel_1, self.janela, 16*escalaTile)
        self.porta = Porta(LARGURA/1.7, ALTURA/5.5)
    ...
    def run(self): 
        ...
        if verificarPosicao:
            jogador.rect.center = [LARGURA/3.5, 400]
